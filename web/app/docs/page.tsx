...
export const metadata = {
  title: 'ProofStream documentation',
  description: 'Protocol documentation, integration references, and install instructions for ProofStream agents and developers.',
};
